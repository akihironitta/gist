...
def f(device, dtype0, dtype1):
        ...
        False, False, False, False, False, False, False,  True, False, False,
        False, False, False, False, False, False, False, False, False, False,
        False, False, False, False, False, False, False, False], dtype=dtype0, device=device)
    ...
    index = torch.tensor(
        ...
        125, 126, 126, 127, 127, 127], dtype=dtype1, device=device)

    assert len(done) == len(index)
    print(device, dtype0, dtype1)
    out = scatter(done, index=index, dim=0, reduce="mul")
    print(torch.where(out == 1)[0])


f("cpu", dtype0=torch.short, dtype1=torch.long)
f("cpu", dtype0=torch.long, dtype1=torch.long)
f("cuda", dtype0=torch.short, dtype1=torch.long)
f("cuda", dtype0=torch.long, dtype1=torch.long)
