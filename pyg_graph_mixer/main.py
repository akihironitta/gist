# https://github.com/pyg-team/pytorch_geometric/blob/2.3.1/examples/reddit.py
import copy
...
class GraphMixer(torch.nn.Module):
    def __init__(self, in_channels, hidden_channels, out_channels) -> None:
        ...
        """
        super().__init__()
        self.link_encoder = torch.nn.ModuleList(
            torch_geometric.nn.TemporalEncoding(100),
            Link
        )
        self.node_encoder = torch.nn.Module()  # FIXME: replace
