...
# https://pytorch-lightning.readthedocs.io/en/1.6.0/common/optimizers.html#bring-your-own-custom-learning-rate-schedulers
# https://fastai.github.io/timmdocs/tanh#TanhLRScheduler
...
class ImageClassifier(LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler = TanhLRScheduler(optimizer, t_initial=50)
